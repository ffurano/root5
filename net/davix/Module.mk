...
$(DAVIXLIB):   $(DAVIXO) $(DAVIXDO) $(ORDER_) $(MAINLIBS) $(DAVIXLIBDEP)
		...
		@$(MAKELIB) $(PLATFORM) $(LD) "$(LDFLAGS)" \
		   "$(SOFLAGS)" libDAVIX.$(SOEXT) $@ "$(DAVIXO) $(DAVIXDO)" \
		   "$(ROOTLIBS) $(DAVIXLIBEXTRA) $(DAVIXLIBDIR) -ldavix"

$(DAVIXDS):    $(DAVIXH) $(DAVIXL) $(ROOTCINTTMPDEP)
		$(MAKEDIR)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMP) -f $@ -c $(DAVIXINCDIR:%=-I%) $(DAVIXH) $(DAVIXL)
